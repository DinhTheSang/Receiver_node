...
(*mesh_lib_generic_server_client_request_cb)(uint16_t model_id,
		uint16_t element_index, uint16_t client_addr, uint16_t server_addr,
		uint16_t appkey_index, const struct mesh_generic_request *req,
		uint32_t transition_ms, uint16_t delay_ms, uint8_t request_flags);
 ...
 */
typedef void
(*mesh_lib_generic_server_change_cb)(uint16_t model_id, uint16_t element_index,
 ...
 */
errorcode_t
mesh_lib_generic_server_response(uint16_t model_id, uint16_t element_index,
 ...
 */
errorcode_t
mesh_lib_generic_server_update(uint16_t model_id, uint16_t element_index,
		const struct mesh_generic_state *current,
		const struct mesh_generic_state *target, uint32_t remaining_ms);
 ...
 */
errorcode_t
mesh_lib_generic_server_publish(uint16_t model_id, uint16_t element_index,
...
mesh_lib_generic_server_register_handler(uint16_t model_id,
		uint16_t element_index, mesh_lib_generic_server_client_request_cb cb,
 ...
 */
errorcode_t
mesh_lib_generic_client_get(uint16_t model_id, uint16_t element_index,
		uint16_t server_addr, uint16_t appkey_index, mesh_generic_state_t kind);
 ...
 */
errorcode_t
mesh_lib_generic_client_set(uint16_t model_id, uint16_t element_index,
		uint16_t server_addr, uint16_t appkey_index, uint8_t transaction_id,
		const struct mesh_generic_request *req, uint32_t transition_ms,
 ...
 */
errorcode_t
mesh_lib_generic_client_publish(uint16_t model_id, uint16_t element_index,
		uint8_t transaction_id, const struct mesh_generic_request *req,
		uint32_t transition_ms, uint16_t delay_ms, uint8_t request_flags);
...
mesh_lib_generic_client_register_handler(uint16_t model_id,
		uint16_t element_index, mesh_lib_generic_client_server_response_cb cb);
